...
Begin VB.Form SakuAbout 
   ...
   Begin VB.PictureBox SakuAboutIcon 
      AutoSize        =   -1  'True
      ClipControls    =   0   'False
      Height          =   540
      Left            =   240
      Picture         =   "SakuAbout.frx":0000
      ScaleHeight     =   337.12
      ScaleMode       =   0  'User
      ScaleWidth      =   337.12
      TabIndex        =   1
      ...
      Width           =   540
   End
   Begin VB.CommandButton SakuAboutOK 
      Cancel          =   -1  'True
      Caption         =   "OK"
      Default         =   -1  'True
      BeginProperty Font 
      ...
      Width           =   1500
   End
   Begin VB.CommandButton SakuAboutSysInfo 
      Caption         =   "Info..."
      BeginProperty Font 
         Name            =   "微软雅黑"
         Size            =   12
   ...
   Begin VB.Line Line1 
      ...
      Y2              =   1687.583
   End
   Begin VB.Label SakuAboutDescription 
      Caption         =   "このアプリは私のためにVisual Basicのコーディングを学ぶためのものです！"
      BeginProperty Font 
         Name            =   "微软雅黑"
         Size            =   9
         Charset         =   134
   ...
   Begin VB.Line Line1 
      ...
      Y2              =   1697.936
   End
   Begin VB.Label SakuAboutVersion 
      Caption         =   "バージョン 2.0"
      BeginProperty Font 
         Name            =   "微软雅黑"
         Size            =   9
      ...
      Width           =   3885
   End
   Begin VB.Label SakuAboutLicense 
      Caption         =   "License：NoLicense"
      BeginProperty Font 
         Name            =   "微软雅黑"
         Size            =   12
         Charset         =   134
...
Private Sub Form_Load()
    Me.Caption = App.Title & "について"
    SakuAboutVersion.Caption = "版本 " & App.Major & "." & App.Minor & "." & App.Revision
    SakuAboutTitle.Caption = App.Title
End Sub
...
Private Sub SakuAboutOK_Click()
SakuAbout.Hide
End Sub

Private Sub SakuAboutSysInfo_Click()
StartSysInfo
End Sub
